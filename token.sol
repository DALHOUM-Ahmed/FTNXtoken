...
// File: contracts/tokens/Fortunx.sol
...
contract FortunX is ERC20, ERC20Burnable, Ownable(msg.sender) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if(_balances[address(this)] >= feeThresholdToCollectStakingRewards){
            super.transferFrom(sender, stakingPool, fee);
        }
    ...
    function excludeFromFee(address _address, bool _isExcludedFromFee) external onlyOwner {
        isExcludedFromFee[_address] = _isExcludedFromFee;
    }
